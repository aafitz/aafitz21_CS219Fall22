...
public class CharacterPlay {
    ...
    // function that counts the english vowels in a string- a,e,i,o,u
   ...
   // }
    public static void main(String [] args) {
        ...
        System.out.println(countVowels("applesauce")== 5); //test code-- # vowels in word/string applesauce should print 5
        System.out.println(countVowels("Hippopotomonstrosesquippedaliaphobia")==16);
        char ch = 'a'; // 'a' is just shorthand for an integer code
                        // assigned by the Unicode Consorrtium
